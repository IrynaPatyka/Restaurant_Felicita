...
<body>
    ...
    <h4>Ціна: $22</h4>
    <ul>
        <li>Паста з морепродуктами</li>
        <li>Кальмари з соусом Песто</li>
    </ul>
    <p>Напій: Вино Шардоне</p>
    <h4>Інгредієнти:</h4>
    <ul>
        <li>Паста з морепродуктами: спагетті, креветки, мідії, червоний лосось, помідори, часник, оливкова олія</li>
        <li>Кальмари з соусом Песто: кальмари, соус Песто, лимон, оливкова олія, спеції</li>
        <li>Вино Шардоне: вино</li>
    </ul>
</div>
...
<div class="set">
    ...
    <ul>
        <li>Стейк рибний</li>
        <li>Гарбузовий крем-суп</li>
    </ul>
    <p>Напій: Сок з граната</p>
    <h4>Інгредієнти:</h4>
    <ul>
        <li>Стейк рибний: філе лосося, лимон, оливкова олія, спеції</li>
        <li>Гарбузовий крем-суп: гарбуз, цибуля, часник, вершки, сіль, перець</li>
        <li>Сок з граната: гранатовий сік</li>
    </ul>
</div>
...
<div class="set">
    ...
    <h4>Ціна: $25</h4>
    <ul>
        <li>Філе курки з рисом</li>
        <li>Салат з авокадо та креветками</li>
    </ul>
    <p>Напій: Мохіто без алкоголю</p>
    <h4>Інгредієнти:</h4>
    <ul>
        <li>Філе курки з рисом: філе курки, рис, соус теріякі, овочі</li>
        <li>Салат з авокадо та креветками: салатні листи, авокадо, креветки, помідори, огірок, соус для заправки</li>
        <li>Мохіто без алкоголю: м'ята, лайм, цукор, сіль, содова, лимонад</li>
    </ul>
</div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            ...
            $sql = "INSERT INTO orders1 (customer_name, customer_surname, phone, dishes, category) VALUES (:customer_name, :customer_surname, :phone, :dishes, 'Вечеря')";
